...
def convert_to_image(base64str):
    base64str = base64str.replace(" ", "+")
    return base64.b64decode(base64str)

def save_image_to(converted_image, image_path):
  image_path = os.path.join(MEDIA_ROOT, image_path)
  fh = open(image_path, 'wb')
  fh.write(converted_image)
  fh.close()
  # root_dir = MEDIA_ROOT
  # if not os.path.exists(os.path.join(root_dir, media_path)):
  #   os.makedirs(os.path.join(root_dir, media_path), 0777)
  # img_path = os.path.join(root_dir, media_path, file_name)
  # fh = open(img_path, "wb")
  # fh.write(converted_image)
  # fh.close()
...
class VideoSession(models.Model):
  ...
  def add_base64_photo(self, content_order, base64str):
    ...
    save_image_to(converted_image, file_path)
